...
const Header = ({img}) => {
  ...
  // Header'a geçtiğimiz props'u App.js de çağırdığımızda , memo kullansak bile Header rerender oluyor. Yani memo kaynaklı olan değişiklikleri render ederken; kendinden kaynaklı olmayan değişiklikleri render etmiyor.
